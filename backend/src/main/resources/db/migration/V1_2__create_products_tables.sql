...
alter table products
    add constraint product_category foreign key (product_category_id) references product_categories (id);
alter table products
    add constraint product_status foreign key (status_id) references product_statuses (id);
alter table reviews
